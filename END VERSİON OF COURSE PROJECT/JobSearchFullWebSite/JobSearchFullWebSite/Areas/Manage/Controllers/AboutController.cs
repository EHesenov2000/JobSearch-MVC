...
namespace JobSearchFullWebSite.Areas.Manage.Controllers
{
    ...
    public class AboutController : Controller
    {
        ...
        public IActionResult Edit(int id,About about)
        {
            ...
            {
                if (about.AboutTopImageId!=null && about.AboutTopImageId.Count() != 6)
                {
                    ModelState.AddModelError("", "Bu hissəyə cəm 6 ədəd şəkil əlavə edilməlidir");
            ...
            else
            {
                ...
                {
                    if (((about.AboutTopImage.Count() + about.AboutTopImageId.Count()) != 6))
                    {
                        ModelState.AddModelError("", "Bu hissəyə cəm 6 ədəd şəkil əlavə edilməlidir");
                        return View(existAbout);
                    }
                ...
                {
                    if (about.AboutTopImage.Count() != 6)
                    {
                        ModelState.AddModelError("", "Bu hissəyə cəm 6 ədəd şəkil əlavə edilməlidir");
                        return View(existAbout);
                    }
