...
namespace JobSearchFullWebSite.Migrations
{
    ...
    [Migration("20210820214519_IsDeletedColumnAddedToJobCandidateAndEmployer")]
    partial class IsDeletedColumnAddedToJobCandidateAndEmployer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobSearchFullWebSite.Models.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JobSearchFullWebSite.Models.ShortList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JobSearchFullWebSite.Models.Admin", b =>
                {
                    b.HasOne("JobSearchFullWebSite.Models.AppUser", "AppUser")
                        .WithOne("Admin")
                        .HasForeignKey("JobSearchFullWebSite.Models.Admin", "AppUserId");
                });
            ...
            modelBuilder.Entity("JobSearchFullWebSite.Models.Candidate", b =>
                {
                    b.HasOne("JobSearchFullWebSite.Models.AppUser", "AppUser")
                        .WithOne("Candidate")
                        .HasForeignKey("JobSearchFullWebSite.Models.Candidate", "AppUserId");
            ...
            modelBuilder.Entity("JobSearchFullWebSite.Models.Employer", b =>
                {
                    b.HasOne("JobSearchFullWebSite.Models.AppUser", "AppUser")
                        .WithOne("Employer")
                        .HasForeignKey("JobSearchFullWebSite.Models.Employer", "AppUserId");
